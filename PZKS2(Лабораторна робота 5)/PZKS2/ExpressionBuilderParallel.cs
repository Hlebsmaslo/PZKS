...
namespace PZKS2
{
    public static class ExpressionBuilderParallel
    {
                ...
                if (prev != null)
                {
                    ...
                    if (leftOperand && rightOperand && t.Type == TokenType.OpenBracket)
                    {
                        errors.Add(new ErrorDetail(
                            "Синтаксична помилка: відсутній коректний оператор (+, -, *, /) між операндом і дужкою.",
                            t.Position,
                            t.Length));
                        prev = t;
                        continue;
                    ...
                    {
                        errors.Add(new ErrorDetail(
                           "Синтаксична помилка: відсутній коректний оператор (+, -, *, /) між дужкою і операндом.",
                           t.Position,
                           t.Length));
                        prev = t;
                        continue;
